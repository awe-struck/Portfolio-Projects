...
|---|---|---|---|
| [Case Study: Ecommerce and Marketing Data Analysis ](https://github.com/awe-struck/ecommerce_and-marketing_data_analysis) | Data Analysis | Using SQL, analyze and optimize marketing channels, measure and test website conversion performance, and use data to understand the impact of new product launches. |
